...
const ItemForm = ({ onSubmit, initialData = {}, isEdit = false }) => {
  const [formData, setFormData] = useState({
    ...
    remind_after: initialData.remind_after || 30,
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      {/* Variety and Category on the same line */}
      <div className="flex space-x-4">
        <div className="flex-1 flex flex-col space-y-1">
          ...
          <input
            ...
            onChange={handleChange}
            className="w-40 px-2 py-1 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 text-gray-600"
          />
        </div>
        <div className="flex-1 flex flex-col space-y-1">
      ...
      <div className="flex space-x-4">
        <div className="flex-1 flex flex-col space-y-1">
          ...
          <input
            ...
            value={formData.qty}
            onChange={handleChange}
            className="w-20 px-2 py-1 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 text-gray-600"
            required
          />
        </div>
        <div className="flex-1 flex flex-col space-y-1">
      ...
      {/* Date Purchased and Remind After on the same line */}
      <div className="flex space-x-4">
        <div className="flex-1 flex flex-col space-y-1">
