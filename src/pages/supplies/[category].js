...
export async function getServerSideProps(context) {
  ...
  try {
    ...
    const res = await fetch(
      `http://localhost:8024/api/supplies?category=${category}`
    );
...
export default function SuppliesCategory({ items }) {
